      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 mb-16">
          {steps.map((item, index) => (
            ...
            >
              <div className="text-6xl sm:text-7xl font-semibold text-primary-foreground/20 mb-6">
                {item.step}
              </div>
        ...
        <div className="text-center">
          <Button
            size="lg"
            className="bg-background text-foreground hover:bg-background/90 rounded-full px-10 text-base font-semibold gap-2"
            asChild
          >
            <a href="#produtos">
              Começar agora
